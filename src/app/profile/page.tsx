...
function Page() {
  ...
  return (
    <Grid container alignContent="center" justifyContent={
      ...
      {marginSm && <Grid container item lg={1} md={1} sm={12} xs={12}
        justifyContent={
          {
            lg:"flex-end",
            md:"flex-end",
      ...
      <Grid container item lg={11} md={11} sm={11} xs={11} justifyContent='center' alignItems="center" gap={2}>
        ...
        <Grid item lg={"auto"} md={"auto"} sm={"auto"} xs={"auto"} >
        <ProfileRightSideCard />
        </Grid>
        
      </Grid>


     {!marginSm && <Grid container item lg={1} md={1} sm={1} xs={1} justifyContent='flex-end'>
      <RightSideAttachedMenu />
      </Grid>
      }
